...
thr1 = 80#75#150. <- for C1 analysis#250.
thr2 = 45#50##120. <- for C1 analysis
...
for slice_idx in slice_range:
    ...
    if (slice_idx+1) < 10:
        ...
        slice_string ='./'+ channel_string + '_2315_plate1_1,1_l_filtered/' + channel_string + '-2315_plate1_1,1_l-000'+str(slice_idx+1)+'.txt'
        
        
    if 100 > (slice_idx+1) > 9:
        #slice_string ='./2315_plate2_3,2_r-only/C1-2315_plate2_3,2_r-only-00'+str(slice_idx+1)+'.txt'
        slice_string ='./' +channel_string +'_2315_plate1_1,1_l_filtered/' + channel_string + '-2315_plate1_1,1_l-00'+str(slice_idx+1)+'.txt'
...
if len(total_neurons[nonzero_first]) ==1:
